...
"" ""
PENS
"Lorenz" 1.0 0 -2674135 true "" "if ticks > 0 [\n  plot-pen-reset\n  set-plot-pen-interval 100 / ( count members )\n  plot 0\n  foreach lorenz-points plot\n  ]"
" 1" 1.0 0 -16777216 true "" "if ticks > 0 [\n  plotxy 0 0\n  plotxy 100 100\n  ]"
...
1117
471
Gini of membership-strength vs. time
NIL
NIL
0.0
100.0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot (gini-index-membership / ( founders + ticks )) / 0.5"
...
530
Gini (ms)
(gini-index-membership / ( founders + ticks )) / 0.5
5
1
11
...
530
Gini (comms)
2 * (gini-index-comms / count members)
5
1
11
...
<experiments>
  <experiment name="intimacy-strength vs. policies" repetitions="24" runMetricsEveryStep="false">
    ...
    <metric>2 * (gini-index-membership / ( founders + ticks ))</metric>
    <metric>total-membership-strength</metric>
    <metric>total-comments</metric>
    <metric>2 * (gini-index-comms / count members)</metric>
    <metric>manager-comms</metric>
